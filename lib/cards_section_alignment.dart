...
class CardsSectionAlignment extends StatefulWidget {
  CardsSectionAlignment(BuildContext context) {
    cardsSize[0] = Size(210,
        260);
    cardsSize[1] = Size(210,
        260);
    cardsSize[2] = Size(210,
        260);
  }
...
class CardsAnimation {
  static Animation<Alignment> backCardAlignmentAnim(
    ...
    return AlignmentTween(begin: cardsAlign[0], end: cardsAlign[1]).animate(
        CurvedAnimation(
            parent: parent, curve: Interval(0.4, 0.7, curve: Curves.easeIn), reverseCurve: Interval(0.2, 0.5, curve: Curves.easeIn)));
  }
  ...
  static Animation<Alignment> middleCardAlignmentAnim(
    ...
    return AlignmentTween(begin: cardsAlign[1], end: cardsAlign[2]).animate(
        CurvedAnimation(
            parent: parent, curve: Interval(0.2, 0.5, curve: Curves.easeIn), reverseCurve: Interval(0.2, 0.5, curve: Curves.easeIn)));
  }
  ...
  static Animation<Alignment> frontCardDisappearAlignmentAnim(
    ...
    return AlignmentTween(
        ...
        .animate(CurvedAnimation(
            parent: parent, curve: Interval(0.0, 0.5, curve: Curves.easeIn),  reverseCurve: Interval(0.2, 0.5, curve: Curves.easeIn)));
  }
}
